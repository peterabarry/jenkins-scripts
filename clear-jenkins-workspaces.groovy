...
def threshold = 2
def skippedLabels = [ ] //don't clean docker slaves
def extraDirectoriesToDelete = [ ] //additional paths under slave's root path that should be removed if found
